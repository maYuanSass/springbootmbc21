...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view :style='{"padding":"160rpx 0 160rpx","borderColor":"#21d5ae","alignItems":"flex-start","display":"block","justifyContent":"space-between","minHeight":"100vh","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20221223/869602be22f342bf8136d5a9f62af2f7.gif) no-repeat right top,url(http://codegen.caihongy.cn/20221223/a3dca8908c4c40b68f285ba0a3226a99.png) no-repeat left top / 100% auto,url(http://codegen.caihongy.cn/20221223/5100c3e4960949eeaacbc47dc102c484.png) no-repeat left bottom / 100% auto,#fff","borderWidth":"2rpx 0","width":"100%","position":"relative","borderStyle":"dashed","height":"auto"}'>
			...
			<view :style='{"width":"100%","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}'>
				...
				<view class="uni-product-list" :style='{"padding":"0px 24rpx 24rpx","margin":"24rpx 0 0","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"calc(100% - 220rpx)","justifyContent":"space-between","height":"auto"}'>
					<view @tap="onDetailTap(product)" class="uni-product" :style='{"padding":"20rpx","boxShadow":"inset 0px 40rpx 64rpx 0px #f9edd9","margin":"0 0 32rpx","borderColor":"#e9be70","display":"flex","borderRadius":"24rpx","flexWrap":"wrap","borderWidth":"2rpx","background":"none","width":"100%","position":"relative","borderStyle":"solid","height":"auto"}' v-for="(product,index) in list" :key="index">
						...
						<image :style='{"padding":"0","margin":"8rpx auto 8rpx","objectFit":"cover","borderRadius":"24rpx","display":"block","width":"100%","height":"240rpx","order":"1"}' mode="aspectFill" class="uni-product-image" :src="baseUrl+product.picture"></image>
					</view>
				</view>
...
<style lang="scss" scoped>
	...
	.category-two .tab {
		...
		width: 100%;
		border-width: 2rpx 2rpx 8rpx 0px;
		border-style: solid;
		text-align: center;
		height: 88rpx;
	}
	...
	.category-two .tab.active {
		...
		line-height: 74rpx;
		border-radius: 0 40rpx 40rpx 0;
		background: linear-gradient(180deg, rgba(255,255,255,.5) 0%, rgba(143,232,213,.5) 80%, rgba(27,208,169,.5) 100%);
		width: 100%;
		border-width: 2rpx 2rpx 8rpx 0px;
		border-style: solid;
		text-align: center;
